...
if (updateExtractionDefinitionModal) {
  ...
  if(splitDropdown != null) {
    ...
    function toggleSplitElements(format) {
      ...
      const splitDropdownContainers = document.getElementsByClassName('js-extraction-definition-split-dropdown-container');
      const splitSelectorContainers = document.getElementsByClassName('js-extraction-definition-split-selector-container');
