...
module Extraction
  ...
  class Execution
    ...
    def enqueue_record_transformation
      transformation_job = TransformationJob.create(transformation_definition: @harvest_job.transformation_definition,               harvest_job: @harvest_job, page: @extraction_definition.page)
