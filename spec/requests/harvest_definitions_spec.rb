  ...
  describe 'POST /create' do
    context 'with valid attributes' do
      it 'creates a new harvest definition' do
        ...
        }.to change(HarvestDefinition, :count).by(1)
      end
    ...
    context 'with invalid attributes' do
      it 'does not create a new harvest definition' do
        ...
        }.to change(HarvestDefinition, :count).by(0)
      end
    end
  end

  describe 'GET /edit' do
    let(:harvest_definition) { create(:harvest_definition, name: 'Staging', content_partner:, extraction_definition:, transformation_definition:, destination:) }
